...
## Descripción
Es una linea de comando que te permite obtener información entre otras opciones,
sobre los links del archivo/directorio que sean de extensión '.md'.

## Como instalarlo? 🧐
  * Instalalo mediante:   
  🌼 npm i md-links-camotito0
